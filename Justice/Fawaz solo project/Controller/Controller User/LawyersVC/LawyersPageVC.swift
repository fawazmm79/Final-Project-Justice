...
//    nameLawyersPage.backgroundColor = .blue
  ...
  lazy var staly2LawyersPage: UILabel = {
    ...
    staly2LawyersPage.backgroundColor = .systemGray4
  ...
  lazy var buttonLawyersPage: UIButton = {
    ...
    buttonLawyersPage.setTitleColor(.black, for: .normal)
    ...
    buttonLawyersPage.backgroundColor = UIColor(red: 0.97, green: 0.81, blue: 0.36, alpha: 1.00)
  ...
  lazy var button2LawyersPage: UIButton = {
    ...
    button2LawyersPage.setTitleColor(.black, for: .normal)
    ...
    button2LawyersPage.backgroundColor = .white
    //Add a Simple Alert with Buttons
